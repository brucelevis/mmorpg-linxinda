...
/**
 * @see com.wan37.logic.skill.SkillEffectLogicEnum#SKILL_EFFECT_LOGIC_1
 */
@Service
class SkillEffectLogicBehav1 implements SkillEffectLogicBehavior {
    ...
    private void attackImpl(FightingUnit caster, FightingUnit target, ISkill skill, AbstractScene scene) {
        // 技能施放对象被施放前处理
        fightingUnitBeCastBeforeHandler.handler(caster, target);
